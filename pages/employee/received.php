...
<head>
    ...
    <title>netit-backend-hr - RECEIVED MESSAGES</title>
            ...
            <div class="d-flex flex-column gap-3 w-100">
                ...
                <div class="profileSettings list-group-flush" id="mainContent">
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM messages WHERE receiver = '$currentusername' ORDER BY sent DESC LIMIT 5";
                ...
                <nav aria-label="Page navigation" class="text-center">
                    <ul class="pagination pagination-sm justify-content-center d-inline-flex" id="pagination">
                        ...
                        <?php
                            ...
                            $query = "SELECT COUNT(*) FROM messages WHERE receiver = '$currentusername'";
                            $result = mysqli_query($DB, $query);
