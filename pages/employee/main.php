        ...
        <main id="main">
            ...
            <div class="d-flex flex-column gap-3 w-100">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="dropdown mx-2">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" id="sortButton">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="sortfilter" value="company-az">
                                    <label class="form-check-label" for="company-az">
                                        COMPANY - A-Z
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="sortfilter" value="company-za">
                                    <label class="form-check-label" for="company-za">
                                        COMPANY - Z-A
                                    </label>
                                </div>
                                <div class="form-check">
                ...
                <?php
                    ...
                    $query = "SELECT jobs.*, employer_info.country, employer_info.city, employer_info.company_name FROM jobs, employer_info WHERE jobs.creator = employer_info.user_id AND jobs.job_status = 'open' ORDER BY jobs.title ASC LIMIT 5";
                    ...
                    if (mysqli_num_rows($result) < 1) {
                        ...
                        foreach ($result as $row) {
                            ...
                            echo    '<a href="./job.php?id='.$row['id'].'" class="list-group-item list-group-item-action d-flex align-items-center">
                                        <div class="w-100">
                                            <p class="fw-bold fs-4 mb-1">'.$row['company_name'].' - '.strtoupper($row['title']).'</p>
                ...
                <nav aria-label="Page navigation" class="text-center">
                    <ul class="pagination pagination-sm justify-content-center d-inline-flex" id="pagination">
                        ...
                        <?php
                            ...
                            $query = "SELECT COUNT(*) FROM jobs WHERE jobs.job_status = 'open'";
                            $result = mysqli_query($DB, $query);
