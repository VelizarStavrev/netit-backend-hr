    ...
    <div class="container-page">
        ...
        <main id="main">
            ...
            <?php
                ...
                $query = "SELECT users.username, candidates.*, jobs.*, employer_info.*, employee_info.* FROM users, candidates, jobs, employer_info, employee_info WHERE users.id = employee_id AND candidates.id = $currentjobid AND jobs.creator = employer_info.user_id AND candidates.employee_id = employee_info.user_id AND candidates.job_id = jobs.id";
            ...
            ?>
                ...
                <div class="sectionDescription d-flex flex-column text-start">
                    <p class="w-100">Username: <?php echo $job['username'] ?></p>
                    <p class="w-100">Name: <?php echo $job['first_name'].' '.$job['last_name'] ?></p>
        ...
        <script src="../../scripts/hr/application.js"></script>
    </div>
</body>
