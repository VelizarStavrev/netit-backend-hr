<?php
    ...
    if(isset($_POST['open'])) {
        ...
        if(!$DB) { 
            ...
            $query = "UPDATE jobs SET job_status = 'open' WHERE jobs.id = $currentjobid";
            $result = mysqli_query($DB, $query);
        ...
        <main id="main">
            ...
            ?>
                ...
                <div class="sectionDescription navbar text-dark justify-content-center position-relative">
                    ...
                    <a href="./offers.php" class="p-2 position-absolute end-0 btn btn-outline-success rounded-circle">
