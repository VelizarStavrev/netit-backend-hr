...
function filterFunc(paginationClicked) {
    ...
    // Request data
    // fetch(`${protocol}//${host}/netit-backend-hr/php/employee/filters.php`, {
    fetch(`${protocol}//${host}/php/employee/filters.php`, {
        method: 'POST',
        headers: {
        ...
        .then(jobs => {
            ...
            for (let job of jobs) {
                ...
                pFirst.textContent = `${job['company_name']} - ${job['title'].toUpperCase()}`;
