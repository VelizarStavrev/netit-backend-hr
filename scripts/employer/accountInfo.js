...
function fieldValidation(form, section) {
    ...
    switch (section) {
        ...
        case 'nextOne':
            ...
            if (inputThree || inputFour || inputSix || inputSeven || inputEight) {
        ...
        case 'nextTwo':
            ...
            inputNine = document.querySelector(`#${'inputNine' + formType} textarea`).value == '' ? true : false;
            ...
            if (inputNine || inputTen || inputEleven) {
