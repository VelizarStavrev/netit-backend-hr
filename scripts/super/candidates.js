// Initial test
console.log('Admin candidates page script load success.');
...
function filterFunc(paginationClicked) {
    ...
    // Request data
    fetch(`http://${host}/netit-backend-hr/php/employer/candidates.php`, { // intentionally left to search in employer
        method: 'POST',
        headers: {
        ...
        .then(candidates => {
            ...
            for (let candidate of candidates) {
                ...
                pFirst.textContent = `${candidate['first_name']} ${candidate['last_name']}`;
