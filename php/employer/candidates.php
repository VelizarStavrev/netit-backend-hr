<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $mainquery = "SELECT candidates.*, employee_info.*, jobs.title FROM candidates, employee_info, jobs WHERE candidates.job_id = $jobid AND employee_info.user_id = candidates.employee_id AND jobs.id = $jobid ORDER BY employee_info.first_name ASC";
