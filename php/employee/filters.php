    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        switch ($sortValues) {
            ...
            case 'company-az':
                ...
                $sort = " ORDER BY employer_info.company_name ASC";
                break;
            
            case 'company-za':

                $sort = " ORDER BY employer_info.company_name DESC";
                break;
        ...
        $mainquery = "SELECT jobs.*, employer_info.country, employer_info.city, employer_info.company_name FROM jobs, employer_info WHERE jobs.creator = employer_info.user_id AND jobs.job_status = 'open'";
